...
predictions_csv_path = 'path/to/Results/prediction_results.csv'
experiment_csv_path = 'path/to/Dataset/cleaned_filtered_data_experiment.csv'
training_csv_path = 'path/to/Dataset/cleaned_filtered_data_train.csv'
output_csv_path = 'path/to/Dataset/combined_cleaned_data.csv'
model_dir = 'path/to/Models/'
versioned_model_dir = 'path/to/versioned_models/'

cleaning_instance = DataCleaning(experiment_csv_path)
def update_reload_flag_lstm():
    flag_file_path = "path/to/Model_reload/reload_flag_lstm.csv"
    pd.DataFrame(['reload']).to_csv(flag_file_path, index=False, header=False)

def update_reload_flag_general():
    flag_file_path = "path/to/Model_reload/reload_flag_general.csv"
    pd.DataFrame(['reload']).to_csv(flag_file_path, index=False, header=False)
    ...
    try:
        ...
        if training_lock.acquire(blocking=True):
            try:
                ...
                log_file_path = 'path/to/Results/retraining_results.csv'
