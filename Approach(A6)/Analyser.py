...
class Analyser:
    ...
    def analyze_drift(self, baseline_predictions_lstm, baseline_predictions_general, real_time_predictions):
        ...
        KL = pd.read_csv('path/to/Knowledge/KL_general.csv', header=None)
        KL_general_threshold = KL.iloc[0, 0]
        KL = pd.read_csv('path/to/Knowledge/KL_LSTM.csv', header=None)
    ...
    def analyze_cpu_usage(self, average_cpu_consumption):
        ...
        cpu_threshold1 = pd.read_csv('path/to/Knowledge/cpu_threshold.csv', header=None)
