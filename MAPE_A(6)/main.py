...
dataset_path = 'Dataset/cleaned_filtered_data_experiment.csv' #path to your dataset on which you want o make the predictions
results_path = 'Results/prediction_results.csv' #path to the csv where you want to save the prediction results
...
def simulate():
    ...
    for index in range(len(data_min) - time_step):
        # Read the model type
        model = safe_read_csv('Model_reload/model.csv') #path to where you read the name of the model which you want to use to make the predictions
